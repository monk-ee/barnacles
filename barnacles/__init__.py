...
from barnacles.modules.cache import cache as cache
...
app = Flask(__name__)
app.secret_key = 'mypanttsttststststhsjhsjhsjhshjs'
app.config['UPLOAD_FOLDER'] = os.path.abspath('barnacles/csv')
app.config['CONFIG_FILE'] = os.path.abspath('barnacles/conf/config.yml')
app.config['ALLOWED_EXTENSIONS'] = set(['zip'])
app.config['CSV_FOLDER'] = os.path.abspath('barnacles/csv/')
...
#import views here
from barnacles.views.main import main as main
